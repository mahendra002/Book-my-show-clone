...
export default function PaymentModal({ isOpen, setIsOpen, price }) {
  ...
  const launchRazorPay = () => {
    let options = {
      key: "rzp_test_JcOpRacrS4Hbm0",
      amount: price * 100,
      currency: "INR",
      name: "Book My Show Clone",
      description: "Movie Rental or Purchase",
      image:
        "https://i.ibb.co/zPBYW3G/imgbin-bookmyshow-office-android-ticket-png.png",
      handler: () => {
        setIsOpen(false);
        alert("Payment Done");
      },
            ...
            >
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="w-full mt-4">
                  ...
                  <button
                    type="button"
                    className="w-full inline-flex justify-center px-4 py-2 text-sm font-medium text-red-700 hover:bg-red-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-red-500"
                    onClick={closeModal}
                  >
                    Cancel Payment
                  </button>
